...
const MultiselectActionable = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, label && /*#__PURE__*/React.createElement(Label, {
  ...
  }, ((!ref ? value : _value) || []).map(x => getLabel(x, normalizedOptions)).join(', ') || /*#__PURE__*/React.createElement(Muted, null, placeholder)), /*#__PURE__*/React.createElement(Popup, {
    ref: popupRef,
    style: popupStyle
    ...
    low: true,
    height: "full"
  }, /*#__PURE__*/React.createElement("div", null, normalizedOptions.length ? normalizedOptions.map(x => /*#__PURE__*/React.createElement(Button, {
    fill: true,
    small: true,
    key: x.value,
    variant: "plain",
...
export { Button, Card, Container, Control, Divider, Flex, Label, Layout, Loading, Muted, NitramUI, NitramUIContext, Pane, Table, ds, modes, themes };
